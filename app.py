...
def force_https():
    ...
    # Toujours forcer HTTPS sur Replit car l'accès externe est toujours en HTTPS
...
def google_auth():
    ...
    # Sur Replit, utiliser le domaine externe HTTPS
...
def google_auth_callback():
    ...
    try:
        ...
        # Construire l'URL de réponse en HTTPS
