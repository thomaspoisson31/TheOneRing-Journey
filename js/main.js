// --- Data ---
        ...
        // Setup season indicator click events in the new voyage container
        ...
        if (seasonIndicator) {
            seasonIndicator.addEventListener('click', () => {
                ...
                if (settingsModal) {
                    ...
                    const allTabs = document.querySelectorAll('.settings-tab-button');
                    ...
                    document.getElementById('season-tab').classList.add('active');
                }
            });
        }
        ...
        loadInitialLocations().then(() => {
            ...
            if (mapImage) {
                mapImage.onload = () => {
                    // clearTimeout(startTimeout); // Commented out to avoid potential issues with multiple calls
                    initializeMap();
                };
                mapImage.addEventListener('error', () => {
                    // clearTimeout(startTimeout); // Commented out
                    handleImageError();
                });
