...
function setupModalEventListeners() {
    ...
    DOM.closeAuthModalBtn.addEventListener('click', toggleAuthModal);
    DOM.googleSigninBtn.addEventListener('click', handleGoogleSignIn);
    DOM.saveContextBtn.addEventListener('click', saveCurrentContext);

    // Add Location Modal
    DOM.getElementById('confirm-add-location').addEventListener('click', confirmAddLocation);
    DOM.getElementById('cancel-add-location').addEventListener('click', cancelAddLocation);

    // Add Region Modal
    DOM.getElementById('confirm-add-region').addEventListener('click', saveRegion);
